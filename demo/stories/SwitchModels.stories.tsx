...
import { Buttons, CompInternal, SharedArgs, StoryArgs, useEngine } from './helpers/tools';
import { createSimpleModel } from './helpers/simpleModel';
import { createComplexModel } from './helpers/complexModel';

export const SwitchModels = Object.assign(
  function SwitchModels(args: StoryArgs) {
