...
import { Buttons, CompInternal, SharedArgs, StoryArgs, useEngine, useRootModel } from './helpers/tools';
import { createComplexModel } from './helpers/complexModel';
import { useForceUpdate } from '@projectstorm/react-workspaces-core';

export const ComplexLayout = Object.assign(
  function ComplexLayout(args: StoryArgs) {
